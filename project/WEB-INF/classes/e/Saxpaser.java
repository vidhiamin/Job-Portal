...
public class Saxpaser extends DefaultHandler {
    ...
    public Saxpaser(String consoleXmlFileName){
		a=1;
		System.out.println("============in sexparser==============");
		hm=new HashMap<String, Job>();
        this.consoleXmlFileName = consoleXmlFileName;
//		System.out.println(this.consoleXmlFileName);
   ...
   private void parseDocument(){
	...
	{
//		new Saxpaser("C:\\tomcat-7.0.34-preconfigured\\apache-tomcat-7.0.34\\webapps\\project\\WEB-INF\\classes\\JobCatalog.xml");
		String TOMCAT_HOME = System.getProperty("catalina.home");	
//"C:\\tomcat-7.0.34-preconfigured\\apache-tomcat-7.0.34\\webapps\\project\\WEB-INF\\classes\\"
		new Saxpaser(TOMCAT_HOME+"\\webapps\\project\\WEB-INF\\classes\\JobCatalog.xml");
    }
}
