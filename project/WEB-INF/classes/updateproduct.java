...
public class updateproduct extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		System.out.println("=================UpdateProduct==========" + session.getAttribute("JobMap"));
		...
		int hm2;
		hm2 = mydata.updatejob(product_id,product_category,product_companyname,product_jobtype,product_jobposition,product_state,product_jobdescription,product_salary,product_experiencelevel);
		out.println("<section id=\"content\">");
		out.println("<h2 style=\"color:red\"> Your job is succesfully updated </h2>"); 
		out.println("</section>"); 
