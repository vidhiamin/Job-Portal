  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
{
	...
	System.out.println("=============pid is here"+ product_id);
	System.out.println("=============Cateogory is here"+ product_category);
	...
	for(Map.Entry<String,Job> entry : hm2.entrySet())
    {
      ...
      out.println("<h2 align=\"center\" margin-top=\"60px\">Job Detail below</h2>");
      ...
      out.println("<div class=\"username\">");
      out.println("<label><b>Job Description</b></label>");
      ...
      out.println("<div class=\"username\">");
      out.println("<label><b>ExperienceLevel</b></label>");
      ...
      out.println("<button class=\"lbutton\" type=\"submit\" value=\"login\">Delete Job</button>");
      out.println("</div>");
